...
namespace backgammonGame
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            if (Form1.Player2.Order && ((Game.row == 1 && Game.row1 == 1) || Game.row == 4))
            {
                Game.Dice1 = 0;
                Game.Dice2 = 0;
                Game.LockedPurple();
            ...
            else if (Form1.Player1.Order && ((Game.row == 1 && Game.row1 == 1) || Game.row == 4))
            {
                Game.Dice1 = 0;
                Game.Dice2 = 0;
                Game.LockedBrown();
        ...
        private void turnButtonVisible(object sender, MouseEventArgs e)
            {
                if (Game.row >= 1 || (Game.row1 == 1 && Game.row == 0))
                    turnRock.Visible = true;
                else if (Game.row == 0 && Game.row1 == 0)
        ...
        private void roll_Click(object sender, MouseEventArgs e)
        {
            ...
            if (!control)
            {
                Game.row = 1;
                Game.row1 = 1;
                MessageBox.Show(actor+ " the player threw.");
